...
\begin{figure}[!tbh]
    \centering
    %\includegraphics*[width=0.45\textwidth]{03-Detectors/Figures/tof0_resolution.eps}
    %\includegraphics*[width=0.45\textwidth]{03-Detectors/Figures/tof1_resolution.eps}
    %\includegraphics*[width=0.45\textwidth]{03-Detectors/Figures/tof2_resolution.eps}
